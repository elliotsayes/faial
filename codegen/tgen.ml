...
let kernel_to_table (racuda : bool) (k : Proto.prog Proto.kernel) : Otoml.t =
  let header = Indent.to_string [header_to_s racuda k] in
...
let gen_toml (racuda : bool) (k : Proto.prog Proto.kernel) : string =
