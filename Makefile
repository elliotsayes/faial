...
BIN = $(BUILD)/bin
TEST = _build/test
all: c-ast pico faial-drf data-dep faial-bc-dyn
...
.PHONY: all clean faial-bc-dyn faial-drf build-test test pico sys-test gitlab gitlab-bin gitlab-test c-ast data-dep
